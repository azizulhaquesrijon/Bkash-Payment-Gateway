...
class PaymentController extends Controller
{
    ...
    public function executepayment()
    {
        ...
        // return $this->_updateOrderStatus($resultdatax);
    ...
    //     if ($resultdatax && optional($resultdatax)->paymentID != null && $resultdatax->transactionStatus == 'Completed') {
            
    //         $request->request->add(['order_no' => $resultdatax->merchantInvoiceNumber]);
    //         $request->request->add(['trxID' => $resultdatax->trxID]);

    //         Http::post(env('BASE_URL').'/api/update-order-payment-status-by-order-no', $request->all());
